...
df <- read_tsv(file = "GCMP_EMP_map_r30_v2_Current.txt", na = c("","NA","na","Not Applicable"),
              col_types = cols(
...
df <- df %>% rename(locationID = collection_id,
                        ...
                        unite(ocean_area, ocean, ocean_superregion) %>%
