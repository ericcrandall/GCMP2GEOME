...
```{r}
# Create a character vector containing all the boolean columns.
boolean = c('binary_tissue_loss',
            'binary_disease',
...
df_renamed <- df %>% 
  mutate_at(boolean, function(x){x == "y"}
                        ) %>%
  rename(locationID = collection_id,
                        ...
                        unite(continentOcean, continentOcean, oceanSuperregion, sep = ":") %>%
                          ...
                          mutate(institutionCode = case_match(institutionCode, " Penn State" ~ "PSU",
                                                                                " KAUST" ~ "KAUST",
                                                                                " AIMS" ~ "AIMS",
                                                                                " OSU" ~ "OSU"))
