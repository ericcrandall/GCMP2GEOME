...
Sample <- df %>% select("basisOfRecord??" = sample_type_EMP, # Need to finalize if this will be the basis of record.
                          ...
                          "taxonomyPhyla AND taxonomyClass AND taxonomyOrder AND taxonomyClade AND genus AND specificEpithet" = full_taxonomy_string_with_clade,
                          ...
                          unite("higherClassification", "Huang_Roy_tree_name", "host_clade_sensu_fukami", "complex_robust", sep=" | ") %>%
                          add_column("namePublishedIn" = "https://doi.org/10.11010.XXX.XXSXX | https://doi.org/10.22231.XXX.XXSXX") %>% # Change to doi for the relevant publications.
