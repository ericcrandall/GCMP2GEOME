...
2. Duplicate materialSampleIDs - we have duplicated MSIDs because each sample has 3 tissues. We need to move tissueIDs and any non-duplicated metadata to a new sheet for each expedition. Eric will do this, for starters
3. Diagnostics. Need to change all y and n values in all Boolean fields to TRUE and FALSE. Colin will do this.
...
write.xlsx(E1, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Australia (Lizard Island E1)", col.names = TRUE, row.names = TRUE)

write.xlsx(E3, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Australia (Lizard Island E3)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E4, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Saudi Arabia (Kaust E4)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E5, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Colombia (Cartagena E5)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E6, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Curacao (E6)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E7, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Australia (Ningaloo E7)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E8, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Singapore (E8)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E9, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Reunion (E9)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)

write.xlsx(E10, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Australia (Lord Howe E10)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)


write.xlsx(E11, "Global Coral Microbiome Mapping v1.xlsx", sheetName = "Panama (Las Perlas E11)", col.names = TRUE, row.names = TRUE, append=TRUE, showNA=TRUE)
