...
Missing fields (left as comments for now but remember to remove the # sign when re-running the code): reef_type, relevant_collaborators, photosynthetically_active_radiation, shelf_location, visibility, visibility_method
...
df_renamed <- df %>% rename(locationID = collection_id,
                          ...
                          oceanSuperregion = ocean_superregion, # concatenate oceanArea, ocean, oceanSuperregion
                          country = country,
                          ...
                          # genus = host_genus_id, # Duplicated with another genus column
